...
yeccpars2_0(S, real, Ss, Stack, T, Ts, Tzr) ->
...
-file("src/egret_parser.yrl", 10).
yeccpars2_5_(__Stack0) ->
 [__1 | __Stack] = __Stack0,
 [begin
   { real , line ( __1 ) , unwrap ( __1 ) }
  end | __Stack].


-file("src/egret_parser.yrl", 38).
